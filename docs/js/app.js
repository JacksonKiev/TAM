...
let menuLinkAll = document.querySelector('.menu__link');
...
menuLinkAll.addEventListener('click', function () {
...
let sliderSlider1 = new Swiper('.hou__small', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.small__controls .more__item_next',
		prevEl: '.small__controls .more__item_prev',
	},
	/*
	breakpoints: {
		320: {
...
let sliderSlider2 = new Swiper('.hou__middle', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.middle__controls .more__item_next',
		prevEl: '.middle__controls .more__item_prev',
	},
	/*
	breakpoints: {
		320: {
...
let sliderSlider3 = new Swiper('.hou__large', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
if (link) {
	...
	window.addEventListener('scroll', function (el) {
		let old_current_link = document.querySelectorAll('._goto-block._active-block');
		if (old_current_link) {
			for (let index = 0; index < old_current_link.length; index++) {
				let el = old_current_link[index];
				el.classList.remove('_active-block');
			}
		}
			...
			if (block_item) {
				...
				if ((pageYOffset > block_offset - window.innerHeight / 3) && pageYOffset < (block_offset + block_height) - window.innerHeight / 3) {
					...
					for (let index = 0; index < current_links.length; index++) {
						...
						current_link.classList.add('_active-block');
					}
				}
			}
		}
